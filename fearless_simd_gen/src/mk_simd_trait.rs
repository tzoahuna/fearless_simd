...
pub fn mk_simd_trait() -> TokenStream {
    ...
    let mut code = quote! {
        ...
        pub trait Simd: Sized + Clone + Copy + Send + Sync + Seal + 'static {
            ...
            type i8s: SimdInt<i8, Self, Block = i8x16<Self>, Mask = Self::mask8s, Bytes = <Self::u8s as Bytes>::Bytes> + SimdFrom<i8, Self>;
            type u16s: SimdInt<u16, Self, Block = u16x8<Self>, Mask = Self::mask16s> + SimdFrom<u16, Self>;
            type i16s: SimdInt<i16, Self, Block = i16x8<Self>, Mask = Self::mask16s, Bytes = <Self::u16s as Bytes>::Bytes> + SimdFrom<i16, Self>;
